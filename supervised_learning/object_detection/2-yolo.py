#!/usr/bin/env python3
"""Implement a filter_boxes method in a Yolo class that selects high-confidence
bounding boxes by combining box confidence and class probabilities,
returning the filtered boxes, their predicted classes, and scores"""
