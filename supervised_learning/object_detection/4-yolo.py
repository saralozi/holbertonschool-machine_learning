#!/usr/bin/env python3
"""Implement a load_images static method in a Yolo class that
reads all images from a folder into numpy arrays and returns
them along with their file paths"""
...
class Yolo:
    ...
    def load_images(folder_path):
        """A method to read all images from a folder into numpy arrays"""
