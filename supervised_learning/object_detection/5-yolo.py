#!/usr/bin/env python3
"""Implement a preprocess_images method in a Yolo class that resizes
and normalizes images for model input while returning the processed
 images and their original shapes"""
...
class Yolo:
    ...
    def preprocess_images(self, images):
        """A method to preprocess images resize with intercubic
        interpolation rescale image"""
